  ...
  "children": [{
    ...
    "option": {
      ...
      "option": {
        ...
        "xAxisSplitLineColor":"#ccc",
        "yAxisSplitLineColor":"#ccc",
        "labelShowColor":"#1E90FF",
        "tipFontSize":15,
        "tipColor":"rgba(30, 144, 255, 1)",
        "areaStyleOpacity":0.5, //面积堆积透明度
        "titleFontSize":20,
        "titleColor":"rgba(30, 144, 255, 1)",
        "titlePostion":"center",
        "subTitleColor":"rgba(30, 144, 255, 1)",
    ...
    children:[
      {
        ...
        "option": {
          ...
          "dataType": 0,
          "dataMethod": 'get',
          "url":"http://api.jeecg.com/mock/26/line/area",
          "time": 5000,
          "component": {
            "width": 800,
             "height": 500,
...

 {
  ...
  "children": [{
    ...
    "option": {
      ...
      "dataType": 0,
      "time": 5000,
      "url":"http://api.jeecg.com/mock/26/text",
      "dataMethod": 'get',
      "dataFormatter": "",
      "data": {
        value: '文本框'
...

{
  ...
  "children":[
    {
      ...
      option: {
        ...
        "dataType": 0,
        "time": 5000,
        "url":'http://api.jeecg.com/mock/26/map',
        "dataMethod": 'get',
        "data": [],
        "dataFormatter": "",
        "component": {
        ...
        "option": {
          "mapData":`${mapUrl}=1235103352843448322`, //默认加载中国地图
          "borderWidth": 1,
          "scale": 87,
          "type": 0,
          "borderColor": "#0dffff",
    ...
    },
    {
      ...
      option: {
          ...
          "option": {
            "geoCoordType":1,
            // 加载中国地图
            "chinaMapUrl":`${mapUrl}=1235103352843448322`, 
            "coolrdProvince":{
                "label":"海门",
                "value":0
            } //全国物流城市默认值
    ...
    option: {
        ...
        "option": {
          "selectProvinceUrl":`${mapUrl}=1235103352843448322`
      },
  ...
  "children": [{
    ...
    "option": {
      ...
      "left": 0,
      "dataType": 0,
      "url": "http://api.jeecg.com/mock/26/img",
      "data": {
        value: './img/source/source16.png'
      },
      "dataFormatter": "",
      "component": {
        "width": 140,
    ...
    option: {
      ...
      "data": [
        {
          value:'https://t8.baidu.com/it/u=2247852322,986532796&fm=79&app=86&size=h300&n=0&g=4n&f=jpeg?sec=1591238823&t=577fe66a6f8ade761102f97db9a0c8c7',
          // value: 'https://img.alicdn.com/tfs/TB1v28TC8v0gK0jSZKbXXbK2FXa-1880-640.jpg',
        }, {
          value:'https://t8.baidu.com/it/u=1484500186,1503043093&fm=79&app=86&size=h300&n=0&g=4n&f=jpeg?sec=1591238823&t=60290375581e54afb2c6557e56077cde',
    ...
    option: {
      ...
      "dataType": 0,
      "dataMethod": 'get',
      "url":"http://api.jeecg.com/mock/26/iframe",
      "time": 50000,
      "data": {
        value: 'http://www.jeecg.com/'
      },
      "dataFormatter": ""
    }
  }, {
    ...
    option: {
      ...
      "dataType": 0,
      "dataMethod": 'get',
      "url":"http://api.jeecg.com/mock/26/video",
      "time": 50000,
      "data": {
  ...
  "children": [{
    ...
    "option": {
      ...
      "dataType": 0,
      "dataMethod": 'get',
      "url":"http://api.jeecg.com/mock/26/flop",
      "time": 3000,
      "data": {
        value: '12345'
      },
    ...
    "option": {
      ...
      "dataType": 0,
      "dataMethod": 'get',
      "url":"http://api.jeecg.com/mock/26/zb2/process",
      "time": 50000,
      "data": {
        "label": "人数增涨",
        "value": 40,
