...
<template>
  <div>
    ...
    <el-form-item label="字体位置">
      <avue-select v-model="main.activeOption.justifyContent"
   ...
   <el-form-item label="开启显隐">
    ...
    <template v-if="main.activeOption.line">
      ...
      <el-form-item label="边框样式">
        <avue-select v-model="main.activeOption.borderStyle" :dic="dicOption.borderStyle">
        </avue-select>
      </el-form-item>
    </template>
  <el-collapse accordion>
    <el-collapse-item title="表头设置">
     <el-form-item label="表头显隐">
      <avue-switch v-model="main.activeOption.headerShow" :default="true">
      </avue-switch>
    </el-form-item>
    ...
    <el-form-item label="表头背景">
      <avue-color type="textarea"
                  v-model="main.activeOption.headerBackground"></avue-color>
    </el-form-item>
      </el-collapse-item>
      </el-collapse>
    <el-collapse accordion>
...
export default {
  ...
  methods: {
    rowSave (row, done) {
      ...
      console.log("roe",row)
      console.log('active',this.tableOption)
      console.log('col',this.main.activeOption.column)
      done()
    },
    rowDel (row, index) {
